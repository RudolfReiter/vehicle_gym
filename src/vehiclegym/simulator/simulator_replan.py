...
from vehiclegym.planner.trajectory_planner_acados_bilevel import VehiclePlannerAcados2022Bilevel
...
class SimpleSimulator(BaseSimulator):
    def __init__(self,
                 ...
                 planners: List[VehiclePlannerAcados2022Bilevel],
                 road: Road,
    ...
    def simulate(self):
        ...
        for i in range(self.options.n_sim):
            ...
            for i_planner, [planner, container, kino_simulator] in enumerate(zip(self.planners,
                ...
                planner.solve_bilevel(states_ego=local_states[i_planner],
